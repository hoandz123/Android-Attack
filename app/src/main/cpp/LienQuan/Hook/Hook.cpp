...
void init() {
    ...
    Tools::Hook((void *)GET_METHOD("Project.Plugins_d.dll", "NucleusDrive.Logic", "LGameActorMgr", "UpdateLogic", 1), (void *)hook_LGameActorMgrUpdateLogic, (void **)&old_LGameActorMgrUpdateLogic);
    Tools::Hook((void *)GET_METHOD("Project_d.dll", "Kyrios.Actor", "ActorManager", "Update", 0), (void *)hook_ActorManagerUpdate, (void **)&old_ActorManagerUpdate);
